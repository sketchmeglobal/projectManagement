...
class Projects extends My_Controller {
    ...
    public function ajax_client_details_table_data() {
        if($this->check_permission() == true) {
            $this->load->model('Projects_m');
            $data = $this->Projects_m->ajax_client_details_table_data();
            echo json_encode($data, JSON_HEX_QUOT | JSON_HEX_TAG);
            exit();
        }
    }
    ...
    public function ajax_logininfo_details_table_data() {
        if($this->check_permission() == true) {
            $this->load->model('Projects_m');
            $data = $this->Projects_m->ajax_logininfo_details_table_data();
            echo json_encode($data, JSON_HEX_QUOT | JSON_HEX_TAG);
            exit();
        }
    }
    ...
    public function ajax_misc_cost_table_data() {
        if($this->check_permission() == true) {
            $this->load->model('Projects_m');
            $data = $this->Projects_m->ajax_misc_cost_table_data();
            echo json_encode($data, JSON_HEX_QUOT | JSON_HEX_TAG);
            exit();
        }
    }
    ...
    public function ajax_commission_details_table_data() {
        if($this->check_permission() == true) {
            $this->load->model('Projects_m');
            $data = $this->Projects_m->ajax_commission_details_table_data();
            echo json_encode($data, JSON_HEX_QUOT | JSON_HEX_TAG);
            exit();
        }
    }
    ...
    public function form_add_client_details(){        
        if($this->check_permission(array()) == true) {
            $this->load->model('Projects_m');
            $data = $this->Projects_m->form_add_client_details();
            echo json_encode($data, JSON_HEX_QUOT | JSON_HEX_TAG);
            exit();
        }
    }
    ...
    public function form_add_misc_cost(){        
        if($this->check_permission(array()) == true) {
            $this->load->model('Projects_m');
            $data = $this->Projects_m->form_add_misc_cost();
            echo json_encode($data, JSON_HEX_QUOT | JSON_HEX_TAG);
            exit();
        }
    }
    ...
    public function form_edit_contact(){        
        if($this->check_permission(array()) == true) {
            $this->load->model('Projects_m');
            $data = $this->Projects_m->form_edit_contact();
            echo json_encode($data, JSON_HEX_QUOT | JSON_HEX_TAG);
            exit();
        }
    }
    ...
    public function form_particular_edit(){        
        if($this->check_permission(array()) == true) {
            $this->load->model('Projects_m');
            $data = $this->Projects_m->form_particular_edit();
            echo json_encode($data, JSON_HEX_QUOT | JSON_HEX_TAG);
            exit();
        }
    }
    ...
    public function form_tax_edit(){        
        if($this->check_permission(array()) == true) {
            $this->load->model('Projects_m');
            $data = $this->Projects_m->form_tax_edit();
            echo json_encode($data, JSON_HEX_QUOT | JSON_HEX_TAG);
            exit();
        }
    }
    ...
    public function form_commission_edit(){        
        if($this->check_permission(array()) == true) {
            $this->load->model('Projects_m');
            $data = $this->Projects_m->form_commission_edit();
            echo json_encode($data, JSON_HEX_QUOT | JSON_HEX_TAG);
            exit();
        }
    }
    ...
    public function del_row_logininfo_details() {
        if($this->check_permission(array()) == true) {
            $this->load->model('Projects_m');
            $data = $this->Projects_m->del_row_logininfo_details();
            echo json_encode($data, JSON_HEX_QUOT | JSON_HEX_TAG);
            exit();
        }
    }   
    ...
    public function del_row_misc_cost_details() {
        if($this->check_permission(array()) == true) {
            $this->load->model('Projects_m');
            $data = $this->Projects_m->del_row_misc_cost_details();
            echo json_encode($data, JSON_HEX_QUOT | JSON_HEX_TAG);
            exit();
        }
    }     
