                            ...
                            <!-- <form id="form_add_offer_details" method="post" action="<?=base_url('admin/form-add-offer-details')?>" class="cmxform form-horizontal tasi-form"> -->
                                <div class="form-group ">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" name="projectAutoGeneratedId" id="projectAutoGeneratedId" class="form-control" value="<?=$projectAutoGeneratedId?>">
                                    </div>
                                        ...
                                        <form autocomplete="off" id="form_particular_basic_info_add" method="post" action="<?=base_url('admin/form-parti-basic-info-add')?>" enctype="multipart/form-data" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group " style="float: left;"> 
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <input id="bi_QuotationNo" name="bi_QuotationNo" type="text" placeholder="Quotation No." class="form-control" value="<?=$bi_QuotationNo?>" />
                                                </div>  
                                                <div class="col-lg-3">
                                        ...
                                        <form autocomplete="off" id="add_invoice_form" method="post" action="<?=base_url('admin/form-add-invoice-info')?>" enctype="multipart/form-data" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group ">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="text" name="inv_BillNo" id="inv_BillNo" class="form-control" value="<?=$inv_BillNo?>" >
                                                </div>   
                                                <div class="col-lg-3">
