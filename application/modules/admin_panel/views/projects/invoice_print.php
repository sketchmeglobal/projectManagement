        ...
        <section class="sheet padding-10mm">
            ...
            <div class="container">
                ...
                <div class="row <?= $class ?> text-uppercase mar_bot_3">
                    <div class="col-sm-12">
                    <h4 class="mar_0 head_font"><u>Invoice</u></h4>
                    </div>
                    <div class="row">
                    <div class="col-sm-6" style="text-align: left;">
                        <p class="mar_0">INVOICE NO: <b><?= $quotation->inv_BillNo ?></b></p>
                    </div>
                        <div class="col-sm-6" style="text-align: right;">
                            <p class="mar_0">Date: <b><?= date('d-m-Y', strtotime($quotation->inv_InvoiceDate)) ?></b></p>
                    </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover width-100" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?=$i + 1?></td>
                                    <td><?=$particulars[$i]->inv_par_TaskType_name?></td>
                                    <td><?=$particulars[$i]->inv_par_HSNCode?></td>
                                    <td><?=$particulars[$i]->inv_par_Duration?></td>
                                    <td><?=date('d-m-Y', strtotime($particulars[$i]->inv_par_StartDate))?></td>
                                    <td><?=number_format($particulars[$i]->inv_Amount, 2)?></td>
                                </tr>
                                <?php } ?>
                                </tbody>
                                </table>
                     ...
                     <footer>
                        ...
                        <div class="col-sm-6 border_all height_190">
                            ...
                            <div class="col-sm-6">
                                <div class="">
                                    <p class="mar_0 text-right"><?= date('d-m-Y', strtotime($quotation->inv_InvoiceDate)) ?></p>
                                </div>
                            </div>
                            <div class="col-sm-12 text-center">
                                <?php if($quotation->tax_ShowStamp == '1') { ?>
