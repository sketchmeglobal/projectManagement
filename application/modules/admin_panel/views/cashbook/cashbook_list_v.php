        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 text-right">
                    <a href="<?= base_url('admin/add-cashbook') ?>" class="btn btn-success  mx-auto"><i class="fa fa-plus"></i> Add New</a>
                    <section class="panel">
                        <div class="panel-body">
                            <table id="cashbook_table" class="table data-table dataTable">
                                <thead>
                                    <tr>
                                        <th>Sl#</th>
                                        <th>Date</th>
...
<script>
    $(document).ready(function() {
        $('#cashbook_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('admin/ajax-cashbook-table-data')?>",
                "type": "POST",
                "dataType": "json",
            },
    ...
    $(document).on('click', '.delete', function(){
        ...
        if(confirm("Are You Sure? This Process Can\'t be Undone.")){
            ...
            $.ajax({
                url: "<?= base_url('admin/ajax-delete-cashbook/') ?>",
                dataType: 'json',
                type: 'POST',
                data: {emp_id: $emp_id},
                success: function (returnData) {
                    ...
                    //refresh table
                    $("#cashbook_table").DataTable().ajax.reload();
