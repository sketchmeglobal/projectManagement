        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 text-right">
                    <a href="<?= base_url('admin/add-salary') ?>" class="btn btn-success  mx-auto"><i class="fa fa-plus"></i> Add <?=$menu?></a>
                    <section class="panel">
                        <div class="panel-body">
                            <table id="salary_table" class="table data-table dataTable">
                                <thead>
                                    <tr>
                                        <th>Sl#</th>
                                        <th>Employee Name</th>
...
<script>
    $(document).ready(function() {
        $('#salary_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('admin/ajax-employee-salary-table-data')?>",
                "type": "POST",
                "dataType": "json",
            },
